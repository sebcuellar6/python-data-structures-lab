...
def basicCalculator(a, b, function):
...
print('Exercise 9:', basicCalculator(2, 5, 'multiply'))
print('Exercise 9:', basicCalculator(10, 2, 'divide'))
print('Exercise 9:', basicCalculator(2, 5, 'add'))
